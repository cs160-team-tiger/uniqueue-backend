...
def add_debug_data():
    ...
    controller.add_question_to_queue(queue_id=100, student_uuid=92, question_text="Question C is asinine")
    controller.add_question_to_queue(queue_id=100, student_uuid=91, question_text="Question D makes me want to cry")
    controller.add_question_to_queue(queue_id=101, student_uuid=88, question_text="Question D is puzzling")
    controller.add_question_to_queue(queue_id=101, student_uuid=89, question_text="Question E is so difficult")
    controller.add_question_to_queue(queue_id=101, student_uuid=92, question_text="Question F is actually pretty easy")
    controller.add_question_to_queue(queue_id=101, student_uuid=90, question_text="Question G is so stumping")
    controller.add_question_to_queue(queue_id=102, student_uuid=89, question_text="Question H is incomprehensible")
